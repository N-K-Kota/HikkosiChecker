//
//  TopPresentationController.swift
//  HikkosiChecker
//
...
class TopPresentationController: UIPresentationController {
    var overlay:UIView!
    ...
    override var frameOfPresentedViewInContainerView: CGRect{
        ...
        let rect = CGRect(origin: CGPoint(x: 10, y: 10), size: CGSize(width:x-20 , height: y-20))
        rect.inset(by:UIEdgeInsets(top: 10, left: 10, bottom: y-10, right: x-10))
        return rect
    }
